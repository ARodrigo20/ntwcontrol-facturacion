...
class App_KernelProdContainer extends Container
{
    ...
    protected function getReportInterfaceService()
    {
        ...
        $this->services['Greenter\\Report\\ReportInterface'] = $instance = new \Greenter\Report\PdfReport(new \App\Service\HtmlReportDecorator(new \Greenter\Report\HtmlReport('', ['cache' => (\dirname(__DIR__, 2).''.\DIRECTORY_SEPARATOR.'prod'), 'strict_variables' => true]), ($this->services['Greenter\\Report\\Resolver\\TemplateResolverInterface'] ?? ($this->services['Greenter\\Report\\Resolver\\TemplateResolverInterface'] = new \Greenter\Report\Resolver\DefaultTemplateResolver()))));
    ...
    protected function getSeeService()
    {
        ...
        $instance->setCachePath((\dirname(__DIR__, 2).''.\DIRECTORY_SEPARATOR.'prod'));
    ...
    protected function getCache_AppService()
    {
        ...
        $this->services['cache.app'] = $instance = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('gmOjHKhxEu', 0, (\dirname(__DIR__, 2).''.\DIRECTORY_SEPARATOR.'prod/pools'), new \Symfony\Component\Cache\Marshaller\DefaultMarshaller(NULL));
    ...
    protected function getCache_SystemService()
    {
        ...
        return $this->services['cache.system'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('x8of5TItdM', 0, $this->getParameter('container.build_id'), (\dirname(__DIR__, 2).''.\DIRECTORY_SEPARATOR.'prod/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    }
    ...
    protected function getCacheWarmerService()
    {
        ...
        }, 1), false, (\dirname(__DIR__, 2).''.\DIRECTORY_SEPARATOR.'prod/App_KernelProdContainerDeprecations.log'));
    }
    ...
    protected function getJmsSerializerService()
    {
        ...
        $a->setCache(new \Metadata\Cache\FileCache((\dirname(__DIR__, 2).''.\DIRECTORY_SEPARATOR.'prod/jms_serializer')));
